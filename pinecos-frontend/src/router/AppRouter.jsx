...
import ReportesCliente from '../pages/reportescliente/ReportesCliente';
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="reportes-cliente" element={<RoleRoute allowedRoles={['ADMIN']}><ReportesCliente /></RoleRoute>} />
